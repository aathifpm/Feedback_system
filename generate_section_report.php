...
$headers = array('Code', 'Subject', 'Faculty', 'Sem', 'Resp', 'Rating');
$data = array();
...
$pdf->CreateMetricsTable($headers, $data);
...
// Create student participation table
$headers = array('Roll No', 'Name', 'Total', 'Submitted', 'Status', '%');
$data = array();
