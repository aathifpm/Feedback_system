 ...
 */
function process_post_images1($files, $upload_dir = 'uploads/') {
...
$tags_result = mysqli_query($blog_conn, $tags_query);
$tags = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['featured_image']) && $_FILES['featured_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($file_extension, $allowed_extensions)) {
            $temp_path = $_FILES['featured_image']['tmp_name'];
    ...
    if (isset($_FILES['post_images']) && !empty($_FILES['post_images']['name'][0])) {
        $uploaded_images = process_post_images1($_FILES['post_images']);
        
        // You can store these paths in a separate table if needed
        // For now, we're just making them available in the editor
    }
    
    // Insert post
    $query = "INSERT INTO blog_posts (title, slug, content, excerpt, featured_image, author_id, status, 
              meta_title, meta_description, published_at) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, " . 
              ($status === 'published' ? "CURRENT_TIMESTAMP" : "NULL") . ")";
              
    $stmt = mysqli_prepare($blog_conn, $query);
    mysqli_stmt_bind_param($stmt, "sssssssss", $title, $slug, $content, $excerpt, $featured_image, 
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        if (!empty($selected_categories)) {
            ...
            mysqli_query($blog_conn, "INSERT INTO blog_post_categories (post_id, category_id) VALUES " . implode(',', $values));
        }
        ...
        if (!empty($selected_tags)) {
            ...
            mysqli_query($blog_conn, "INSERT INTO blog_post_tags (post_id, tag_id) VALUES " . implode(',', $values));
        }
        
        header("Location: post-edit.php?id=$post_id&message=Post created successfully");
        exit;
    } else {
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="content" class="editor-content" contenteditable="true" role="textbox" aria-multiline="true" spellcheck="true"></div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="image-upload-container">
                                            ...
                                            <small class="text-muted">Upload multiple images to insert into your post content. Select an image and click "Insert" to add it at cursor position.</small>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">A short summary of the post. If not provided, it will be generated from the content.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">If not provided, the post title will be used.</div>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="meta_description" class="form-label">Meta Description</label>
                                        <textarea class="form-control" id="meta_description" name="meta_description" rows="2"></textarea>
                                        <div class="form-text">If not provided, the excerpt will be used.</div>
                                    </div>
        ...
        document.getElementById('post_images').addEventListener('change', function(e) {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                reader.onload = function(event) {
                    ...
                    captionBtn.textContent = 'With Caption';
                ...
                if (document.activeElement === editor) {
                    switch (e.key.toLowerCase()) {
                        ...
                        case 's': // Save draft
                            ...
                            alert('Saving draft...');
                            // You could implement AJAX saving here
                            break;
                    }
                }
            }
